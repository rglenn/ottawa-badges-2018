#pragma once
#include "Arduino.h"
// Indexes are ASCII, offset by 32 (to cover non-printing characters)
// Font from https://github.com/tompreston/4x5-Font/blob/master/4x5-font.js
const uint8_t fontWidth = 4;
const uint8_t fontHeight = 5;
const uint8_t fontMask = 0x0F;
const PROGMEM uint8_t fontArray[96][5] = {
